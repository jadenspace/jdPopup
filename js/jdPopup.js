...
JdPopup.cssExtract = function cssExtract(elem) {
...
JdPopup.prototype.complete = function (isOn) {
    ...
    if (this.constructor.cssExtract(this.$layer)) {
        this.$layer.addEventListener('transitionend webkitTransitionend', completeFn);
    } else {
